 ...
 */
final class Version20230428133545 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE matches_profil (matches_id INT NOT NULL, profil_id INT NOT NULL, INDEX IDX_A31153AA4B30DD19 (matches_id), INDEX IDX_A31153AA275ED078 (profil_id), PRIMARY KEY(matches_id, profil_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
